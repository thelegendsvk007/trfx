          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col">
              ...
              <div className="bg-card border border-border/50 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="h-[700px] p-0 bg-[#131722] text-white overflow-hidden">
                  ...
                  <div className="relative h-full w-full bg-[#131722] overflow-hidden">
                    ...
                    <div className="flex">
                      ...
                      <div className="w-20 h-[628px] flex flex-col justify-between p-1 text-right text-xs text-[#d1d4dc] border-r border-[#2A2E39]">
                        <div>3,252.500</div>
                        <div>3,250.000</div>
                        <div>3,247.500</div>
                        <div>3,245.000</div>
                      ...
                      <div className="flex-1 relative">
                        ...
                        <div className="w-full h-[628px] overflow-hidden relative">
